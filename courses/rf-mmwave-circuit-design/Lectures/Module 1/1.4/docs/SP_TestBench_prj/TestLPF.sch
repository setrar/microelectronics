...
<Properties>
  <View=0,-34,2156,1040,0.826447,47,0>
  <Grid=10,10,1>
  <DataSet=TestLPF.dat>
...
<Components>
  ...
  <NutmegEq StoZ_Conversion_Template1 1 1550 120 -27 19 0 0 "ac" 1 "StoZ_Z0=50.0" 1 "StoZ_DelSxZ0=(  (1-V(nS11))*(1-V(nS22))-V(nS12)*V(nS21)  )/StoZ_Z0" 1 "Z11=(  (1+V(nS11))*(1-V(nS22))+V(nS12)*V(nS21) )/StoZ_DelSxZ0" 1 "Z12=2*V(nS12)/StoZ_DelSxZ0" 1 "Z21=2*V(nS21)/StoZ_DelSxZ0" 1 "Z22=((1-V(nS11))*(1+V(nS22))+V(nS12)*V(nS21))/StoZ_DelSxZ0" 1>
</Components>
<Wires>
